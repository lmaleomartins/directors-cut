...
DROP TRIGGER IF EXISTS trigger_validate_featured_movies_insert ON public.movies;
DROP TRIGGER IF EXISTS trigger_validate_featured_movies_update ON public.movies;

-- Remover função existente se existir
DROP FUNCTION IF EXISTS public.validate_featured_movies_limit();
